...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ///Anda bisa mengaktifkan notifikasi dengan menambahkan kode berikut
    ...
    //method notifikasi untuk melihat hasil dari Alarm Manager
    private void showAlarmNotification(Context context, String title, String message, int notifId){
        String CHANNEL_ID = "Channel_1";
        String CHANNEL_NAME = "AlarmManager channel";

        NotificationManager notificationManageCompat = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            ...
            if(notificationManageCompat != null){
    ...
    ///CODELAB REPEATING ALARM MANAGER
